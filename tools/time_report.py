...
def parse_arguments():
    ...
    parser.add_argument("command", choices=["sync_time", "get_time_report", "get_current_session_id", "new_session"],
                        help="Command to execute on the 3-key device.")
    parser.add_argument("-s", "--session_id", type=int, default=None,
